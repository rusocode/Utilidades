...
class Lamina extends JPanel {
	...
	private boolean es_negrita, es_cursiva; // FIXME - Â¿Por que las declaro como variables de clase?
	...
	public Lamina() {
		 ...
		 * 
		 * JMenu tamaÃ±o = new JMenu("TamaÃ±o"); configurarMenu1(tamaÃ±o, "12"); configurarMenu1(tamaÃ±o, "16");
		 * configurarMenu1(tamaÃ±o, "18"); configurarMenu1(tamaÃ±o, "20"); */
	...
	private void configurarMenu2() {
		...
		/* Le sumo 1 al tamaÃ±o de la matriz textoItem por que la instruccion textoItem.length almacena el maximo desde la
			...
			for (int j = 0; j < textoItem[i].length; j++) { // textoItem[i].length calcula la cantidad de columnas para la fila i.
				...
				menu[i].add(item[i][j]).addActionListener(new ActionListener() { // fuente.add(arial);
					...
					public void actionPerformed(ActionEvent e) {
						...
						// Otra forma de idetificar la seleccion del tamaÃ±o.
